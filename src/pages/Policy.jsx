	...
	return (
		<div className="Policy">
			...
			<p>
				...
				<br />A continuación, te invitamos a que leas en detalle y aprendas más acerca de nuestra
			...
			<div className="body">
				...
				<br />
				<br />
				Puedes solicitar la eliminación de tus backups y toda la información asociada. Para ello
				puedes acudir al servidor de soporte donde eliminaremos toda tu informacion del bot.
			</div>
			<br />
